        ...
        <div className="navbar p-0">
            <div className="flex justify-between flex-1  lg:flex-none lg:justify-start">
                ...
                <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3  p-2 shadow bg-base-100 rounded-box w-52 z-50">
                    <NavLink to="/" className={({isActive}) => isActive ? 'text-white font-semibold ' : 'text-base font-medium'}>Home</NavLink>
                    {
                        user && 
                        <NavLink to='/addbooks' className={({isActive}) => isActive ? 'text-white font-semibold text-base' : 'font-medium text-base'} >Add Books</NavLink>
                    }
                    {
                        user && 
                        <NavLink to='/allbooks' className={({isActive}) => isActive ? 'text-white font-semibold text-base' : 'font-medium text-base'} >All Books</NavLink>
                    }
                    {
                        user &&
